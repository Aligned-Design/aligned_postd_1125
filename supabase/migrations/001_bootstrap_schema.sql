...
CREATE INDEX IF NOT EXISTS idx_content_packages_brand_id ON content_packages(brand_id);
...
CREATE INDEX IF NOT EXISTS idx_brand_history_brand_id ON brand_history(brand_id);
...
CREATE INDEX IF NOT EXISTS idx_brand_success_patterns_brand_id ON brand_success_patterns(brand_id);
...
CREATE INDEX IF NOT EXISTS idx_collaboration_logs_brand_id ON collaboration_logs(brand_id);
...
CREATE INDEX IF NOT EXISTS idx_performance_logs_brand_id ON performance_logs(brand_id);
...
CREATE INDEX IF NOT EXISTS idx_platform_insights_brand_id ON platform_insights(brand_id);
CREATE INDEX IF NOT EXISTS idx_platform_insights_platform ON platform_insights(platform);

CREATE INDEX IF NOT EXISTS idx_token_health_brand_id ON token_health(brand_id);
CREATE INDEX IF NOT EXISTS idx_token_health_status ON token_health(status);

CREATE INDEX IF NOT EXISTS idx_weekly_summaries_brand_id ON weekly_summaries(brand_id);
CREATE INDEX IF NOT EXISTS idx_weekly_summaries_week_start ON weekly_summaries(week_start);

CREATE INDEX IF NOT EXISTS idx_advisor_review_audits_brand_id ON advisor_review_audits(brand_id);
