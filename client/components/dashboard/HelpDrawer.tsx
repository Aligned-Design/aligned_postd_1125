...
const KEYBOARD_SHORTCUTS = [
  { keys: ["?"], description: "Open help drawer" },
  { keys: ["Esc"], description: "Close current modal or drawer" },
  { keys: ["Ctrl/⌘", "K"], description: "Open search" },
  { keys: ["Ctrl/⌘", "N"], description: "Create new content" },
  { keys: ["Ctrl/⌘", "S"], description: "Save current work" },
  { keys: ["Ctrl/⌘", "Enter"], description: "Submit / Confirm" },
      ...
      <Dialog open={showShortcuts} onOpenChange={setShowShortcuts}>
        <DialogContent className="max-w-md">
          ...
          <p className="text-xs text-slate-500 mt-4 pt-4 border-t border-slate-200">
            💡 Press <kbd className="px-1 py-0.5 bg-slate-100 border border-slate-200 rounded text-xs font-mono">?</kbd> anywhere to open this dialog
          </p>
        </DialogContent>
      </Dialog>
    </div>
