...
export default function Screen5BrandSummaryReview() {
  ...
  // Extract images from brand snapshot (now from real scrape)
  const brandImages = brandSnapshot.extractedMetadata?.images && brandSnapshot.extractedMetadata.images.length > 0
    ? brandSnapshot.extractedMetadata.images
    : [
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-white/50 backdrop-blur-xl rounded-2xl border border-white/60 p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xs text-slate-500">{brandImages.length} images</span>
            </div>
